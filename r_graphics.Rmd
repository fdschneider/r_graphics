...
```{r}
install.packages("ggplot2", "readxl", "data.table", "RColorBrewer", "colorspace")
```
...
Finally, ggplot2 comes with tools for color choice that are embedded in all of its geom and scale functions.
...
Produce a print output for your graphic from Exercise 2. 
